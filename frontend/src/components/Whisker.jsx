      ...
      <div className={`flex w-full rounded-br-[25px]  gap-4 ${whiskerVisible ? 'h-[0px]' : 'flex h-auto p-3'} transition-all duration-200`}> 
        { points == 0 && user ? (
          ...
          <div className='flex flex-col gap-2 h-auto w-auto'>
            <Link to="/leaderboard" className={`${whiskerVisible ? "h-0 hidden" : "min-h-aut flex"} w-full justify-between items-center bg-[#889132] hover:bg-[#C2CB6A] active:bg-[#889132] rounded-[10px] px-3 py-1`}>
              <span className='text-[#FFF] text-[12px] whitespace-nowrap font-bold'>WhiskerMeter Leaderboards</span>
