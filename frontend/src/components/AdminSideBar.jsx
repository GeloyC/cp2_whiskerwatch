...
const AdminSideBar = ({ className }) => {
  ...
  return (
    <div
      ref={sidebarRef}
      className={`relative flex flex-col h-screen bg-[#FFF] z-50 transition-all duration-300 ease-in-out ${
        sidebarShow ? 'w-64' : 'w-16'
      } ${className}`}
    >
      {error && (
        <div className="p-3 text-[#DC8801] bg-[#FDF5D8] rounded-lg text-[14px]">
      ...
      <div
        className={`flex items-center gap-4 h-[80px] box-border pt-4 pb-4 cursor-pointer bg-white border-b-2 border-b-[#DC8801] ${
          sidebarShow ? 'pl-3 pr-8 justify-between' : 'justify-center'
        }`}
      >
        <div className={`flex items-center gap-2 ${sidebarShow ? '' : 'hidden'}`}>
          <div className="flex justify-center items-center w-[80px] h-auto p-1">
            <img
              onClick={() => navigate('/dashboard')}
              src="/assets/whiskerwatchlogo-no textmarks.png"
        ...
        <button className="w-[40px] h-[40px]" onClick={handleShowSidebar}>
          <img
            src="/assets/icons/burger-bar.png"
            alt="Toggle sidebar"
            className={`cursor-pointer w-full h-full object-cover transition-transform duration-300 ${
              sidebarShow ? 'rotate-90' : 'rotate-0'
            }`}
          />
        </button>
      </div>

      <div className={`flex flex-col justify-between h-full p-1 ${sidebarShow ? '' : 'items-center'}`}>
        <div className="flex flex-col justify-center">
          <Link to="/dashboard" className={location.pathname === '/dashboard' ? sideItemStyleCurrent : sideItemStyle}>
            <div className="flex flex-row items-center gap-4">
              <div className="flex justify-center items-center w-[30px] h-auto">
                <img src="/assets/icons/admin-icons/sidedbar/dashboard.png" alt="Dashboard icon" />
              </div>
              <label
                className={`cursor-pointer font-bold transition-opacity duration-300 ${
                  sidebarShow ? 'opacity-100' : 'opacity-0 w-0 overflow-hidden'
                }`}
              >
                Overview
              </label>
          ...
          <Link
            ...
            className={
              user?.role === 'head_volunteer'
                ? 'hidden'
                : location.pathname === '/admincatprofile' || location.pathname.includes('/catprofileproperty/')
          ...
          >
            <div className="flex flex-row items-center gap-4">
              <div className="flex justify-center items-center w-[30px] h-auto">
                <img src="/assets/icons/admin-icons/sidedbar/cat-profile.png" alt="Cat profiles icon" />
              </div>
              <label
                className={`cursor-pointer font-bold transition-opacity duration-300 ${
                  sidebarShow ? 'opacity-100' : 'opacity-0 w-0 overflow-hidden'
          ...
          <div
            className={
              location.pathname === '/adopterslist' || location.pathname === '/adopterapplication' || location.pathname.includes('/adopterslist/') || location.pathname.includes('/adopterapplication/')
                ? sideItemDownCurrent
                : sideItemStyle
            }
          >
            <div className="flex flex-row items-center justify-between w-full active:text-[#B5C04A]">
              <div className="flex flex-row items-center gap-4">
                <div className="flex justify-center items-center w-[30px] h-auto">
                  <img src="/assets/icons/admin-icons/sidedbar/adopters-visitors.png" alt="Adopters icon" />
                </div>
                <label
                  className={`cursor-pointer font-bold transition-opacity duration-300 ${
                    sidebarShow ? 'opacity-100' : 'opacity-0 w-0 overflow-hidden'
              ...
              <button
                onClick={() => toggleDropdown('adopters')}
                className={`flex justify-center items-center w-[30px] h-auto p-[8px] rounded-[25px] hover:bg-[#FDF5D8] active:bg-[#FFF] transition-opacity duration-300 ${
                  sidebarShow ? 'opacity-100' : 'opacity-0'
                }`}
              >
                <img
                  src="/assets/icons/down-arrow-orange.png"
                  alt="Toggle adopters dropdown"
                  className={`transition-transform duration-300 ${dropdown.adopters ? '-rotate-90' : 'rotate-0'}`}
                />
              </button>
            </div>
            <div
              className={`flex flex-col transition-all duration-300 ease-in-out ${
                dropdown.adopters && sidebarShow ? 'max-h-40 opacity-100' : 'max-h-0 opacity-0 overflow-hidden'
              }`}
            >
              <Link
                to="/adopterslist"
                className={sidebarShow ? (location.pathname === '/adopterslist' || location.pathname.includes('/adopterslist/') ? pageActive : pageInactive) : 'hidden'}
              >
                Adopters List
              </Link>
              <Link
                to="/adopterapplication"
                className={sidebarShow ? (location.pathname === '/adopterapplication' || location.pathname.includes('/adopterapplication/') ? pageActive : pageInactive) : 'hidden'}
              >
                Applications
              </Link>
            </div>
          ...
          <div
            className={
              location.pathname === '/feedingvolunteers' || location.pathname === '/feedingapplications' || location.pathname === '/report' || location.pathname === '/donationadmin' || location.pathname.includes('/feedingapplications/')
                ? sideItemDownCurrent
                : sideItemStyle
            }
          >
            <div className="flex flex-row items-center justify-between w-full active:text-[#B5C04A]">
              <div className="flex flex-row items-center gap-4">
                <div className="flex justify-center items-center w-[30px] h-auto">
                  <img src="/assets/icons/admin-icons/sidedbar/in-kind-donation-application.png" alt="Feeding icon" />
                </div>
                <label
                  className={`cursor-pointer font-bold transition-opacity duration-300 ${
                    sidebarShow ? 'opacity-100' : 'opacity-0 w-0 overflow-hidden'
              ...
              >
                <img
                  src="/assets/icons/down-arrow-orange.png"
                  alt="Toggle feeding dropdown"
                  className={`transition-transform duration-300 ${dropdown.feeding ? '-rotate-90' : 'rotate-0'}`}
                />
              </button>
            </div>
            <div
              className={`flex flex-col transition-all duration-300 ease-in-out ${
                dropdown.feeding && sidebarShow ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0 overflow-hidden'
              }`}
            >
              <Link
                to="/feedingvolunteers"
              ...
              <Link
                to="/feedingapplications"
                className={sidebarShow ? (location.pathname === '/feedingapplications' || location.pathname.includes('/feedingapplications/') ? pageActive : pageInactive) : 'hidden'}
              >
                Applications
              </Link>
              <Link
          ...
          <div
            className={
              user?.role === 'head_volunteer'
                ? 'hidden'
                : location.pathname === '/adminlist' || location.pathname === '/allusers' || location.pathname.includes('/userprofile')
                ? sideItemDownCurrent
                : sideItemStyle
            }
          >
            <div className="flex flex-row items-center justify-between w-full active:text-[#B5C04A]">
              <div className="flex flex-row items-center gap-4">
                <div className="flex justify-center items-center w-[30px] h-auto">
                  <img src="/assets/icons/admin-icons/sidedbar/settings.png" alt="Manage icon" />
                </div>
                <label
                  className={`cursor-pointer font-bold transition-opacity duration-300 ${
                    sidebarShow ? 'opacity-100' : 'opacity-0 w-0 overflow-hidden'
              ...
              >
                <img
                  src="/assets/icons/down-arrow-orange.png"
                  alt="Toggle manage dropdown"
                  className={`transition-transform duration-300 ${dropdown.manage ? '-rotate-90' : 'rotate-0'}`}
                />
              </button>
            </div>
            <div
              className={`flex flex-col transition-all duration-300 ease-in-out ${
                dropdown.manage && sidebarShow ? 'max-h-40 opacity-100' : 'max-h-0 opacity-0 overflow-hidden'
              }`}
            >
              <Link
                to="/adminlist"
              ...
              <Link
                to="/allusers"
                className={sidebarShow ? (location.pathname === '/allusers' || location.pathname.includes('/userprofile') ? pageActive : pageInactive) : 'hidden'}
              >
                All Users
              </Link>
            </div>
        ...
        <div
          className={`relative flex flex-row items-center ${
            sidebarShow ? 'justify-between pr-2' : 'justify-center w-fit pr-1'
          } p-1 gap-3 text-[#000] font-bold bg-[#94b946] rounded-[50px]`}
        >
          <div className="flex flex-row items-center gap-3">
            <div onClick={toggleVisibilityProfile} className="flex justify-center items-center w-[40px] h-[40px] rounded-[25px] overflow-hidden">
              <img
                src={profileImage ? `${url}/FileUploads/${profileImage}` : '/assets/icons/account.png'}
                alt="Profile"
                className="w-full h-full object-cover"
              />
            </div>
            <label
              className={`transition-opacity duration-300 ${sidebarShow ? 'opacity-100' : 'opacity-0 w-0 overflow-hidden'}`}
            >
              {sessionLoading ? 'Loading...' : user ? `${user.firstname || ''} ${user.lastname || ''}` : 'Guest'}
            </label>
          </div>
          <button
            onClick={toggleVisibilityProfile}
            className={`flex justify-center items-center w-[30px] h-auto p-2 bg-[#f0f2c8] hover:bg-[#E3E697] active:bg-[#f0f2c8] rounded-[15px] transition-opacity duration-300 ${
              sidebarShow ? 'opacity-100' : 'opacity-0'
            }`}
          >
            <img src="/assets/icons/admin-icons/arrow-right.png" alt="Toggle profile menu" />
          </button>
          <div
            className={`absolute flex flex-col w-auto gap-2 box-border bg-[#FFF] shadow-md rounded-[15px] rounded-bl-[0px] z-[9999] transition-all duration-300 ${
              sidebarShow ? 'left-64 bottom-12' : 'left-16 bottom-5'
            ...
            {isLoggedIn && (
              <div className={isVisible ? 'flex flex-col w-fit p-2 gap-2' : 'hidden'}>
                <Link
                  ...
                  className="text-[#000] text-center p-3 pl-6 pr-6 w-full bg-[#f0f2c8] hover:bg-[#E3E697] active:bg-[#f0f2c8] active:text-[#FFF] rounded-[10px]"
                >
                  <label className="w-full whitespace-nowrap">Log out</label>
                </Link>
              </div>
