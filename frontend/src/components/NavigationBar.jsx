            ...
            {isLoggedIn ? (
              <div className='flex items-center justify-center w-fit border-box gap-2'>
                ...
                <div ref={profileMenuRef} className='relative flex-col'>
                  ...
                  <div className={isVisible ? 'absolute -right-5  xl:top-10 xl:-right-5 lg:-right-20 md:-right-20 flex flex-col items-start xl:w-auto h-auto bg-[#FFF] border-2 border-[#DC8801] rounded-[10px] rounded-tr-[4px] overflow-hidden' : 'hidden'}>
