...
const NotificationBell = () => {
  ...
  return (
    <div ref={menuRef} className="relative xl:flex lg:flex md:flex w-full h-full">
      ...
      {/* Dropdown */}
      {isOpen && (
        <div  className={"absolute top-8 right-8 bg-white border-2 border-[#DC8801] rounded-[10px] rounded-tr-[0px] z-50 w-[300px] h-[400px] scrollbar-thin overflow-y-scroll"}>
