...
//                 <div className='flex flex-col xl:p-10 lg:p-10 min-h-screen w-full gap-4 w-full mx-auto overflow-hidden'>
...
const FeedingApplicationView = () => {
    ...
    const handleUpdateStatus = async (status) => {
        try {
            ...
            if (status === 'Accepted') {
                setStatusMessage(`${applicant.firstname} ${applicant.lastname}'s application is accepted. Update successful!`);
            } else if (status === 'Rejected') {
                setStatusMessage(`${applicant.firstname} ${applicant.lastname}'s application is rejected. Update successful!`);
            }
