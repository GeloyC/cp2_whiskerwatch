...
//                     withCredentials: true, // Add authentication
//                 });
...
//         }
//         return url; // Fallback for non-Cloudinary URLs
//     };
...
//     if (!user) return <div>No user session.</div>;
...
//                                         <label className='text-[#2F2F2F] text-[18px] font-bold'>{applicant.application_date}</label>
//                                     </div>
//                                 </div>
//                             )}
