      ...
      <div className='flex flex-col items-center h-full w-full overflow-hidden'>
          <div className='flex flex-col box-border w-full'>
            ...
            <div className='flex flex-col items-center w-full'>
              ...
              <div className='grid grid-rows-1 xl:grid-cols-2 lg:grid-cols-2 md:grid-cols-2 xl:flex-row w-full h-full xl:p-10 lg:p-10 md:p-10  gap-5 px-4 justify-between items-center leading-tight bg-[#FFF] bg-[url(/assets/background-paws.png)] bg-cover bg-fit bg-repeat'>
