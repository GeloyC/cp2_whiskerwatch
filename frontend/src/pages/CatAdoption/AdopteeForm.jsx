...
const AdopteeForm = () => {
    ...
    const generateAdoptionForm = async () => {
        ...
        try {
            ...
            setSubmitMessage(`Adoption Application Form submitted successfully! \n\n Thanks for submitting your form. We will review your application and reach out to you shortly through your provided contact info. This is for the screening process to ensure that our rescued cats go to loving homes. \n\n We're thrilled you're ready to open your heart and home to a furry friend!`);
        } catch (err) {
                ...
                <div className="flex flex-col w-full max-w-[1200px] gap-5 sm:px-6 xl:px-0">
                    <div className="flex flex-col w-full xl:grid xl:grid-cols-[20%_80%] gap-2">
                        ...
                        {!submitMessage ? (
                            ...
                            <div className="flex items-center justify-center p-5 bg-[#FFF] rounded-[15px] w-full h-fit">
                                {error ? (
                    ...
                    {isFormStarted && (
                        <button
                            ...
                            disabled={loading}
                            className={!submitMessage ? `self-end cursor-pointer w-full xl:w-fit lg:w-fit md:w-fit text-center font-bold p-2 pl-5 pr-5 rounded-[10px] ${
